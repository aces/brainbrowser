...
var g=this,h=[];return g.volumes.forEach(function(a){var b=a.slice(d,e,f);h.push(b)}),{height_space:h[0].height_space,width_space:h[0].width_space,getImage:function(d,e,f){d=d||1;var i=[],j=0,k=0;return h.forEach(function(a){var h,l=a.color_map;if(!l)throw h="No color map set for this volume. Cannot render slice.",g.triggerEvent("error",{message:h}),new Error(h);var m=a.width_space.step,n=a.height_space.step,o=Math.abs(Math.floor(a.width*m*d)),p=Math.abs(Math.floor(a.height*n*d)),q=c.createImageData(a.width,a.height),r=c.createImageData(o,p);l.mapColors(a.data,{min:a.min,max:a.max,contrast:e,brightness:f,destination:q.data}),0>m&&n>0&&q.data.set(b.utils.flipImage(q.data,q.width,q.height,{flipx:!0,flipy:!1,block_size:4})),r.data.set(b.utils.nearestNeighbor(q.data,q.width,q.height,o,p,{block_size:4})),j=Math.max(j,o),k=Math.max(k,p),i.push(r)}),a(i,g.blend_ratios,c.createImageData(j,k))}}},getIntensityValue:function(a,b,c,d){a=void 0===a?this.position.xspace:a,b=void 0===b?this.position.yspace:b,c=void 0===c?this.position.zspace:c,d=void 0===d?this.current_time:d;var e=this,f=[];return e.volumes.forEach(function(e){(0>a||a>e.data.xspace.space_length||0>b||b>e.data.yspace.space_length||0>c||c>e.data.zspace.space_length)&&f.push(0);var g,h,i=e.data.slice("zspace",c,d),j=i.data;"xspace"===i.width_space.name?(g=a,h=b):(g=b,h=c),f.push(j[(i.height_space.space_length-h-1)*i.width+g])}),f.reduce(function(a,b,c){return a+b*e.blend_ratios[c]},0)}};f.forEach(function(a){g.volumes.push(a),g.blend_ratios.push(1/f.length)}),BrainBrowser.utils.isFunction(e)&&e(g)}}();