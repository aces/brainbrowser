function WaveformObj(data) {
 var obj = this;
  ...
  var texCoordArray = [];
  var normalArray = [];
  current_shape = {name: data.name | "undefined", indexArray:[], texIndexArray:[], normalIndexArray: []};
  ...
  for(var i =0; i< data.length; i++) {
    ...
    if(!(line[0].match("#")) || line == "") {
	  ...
	  console.log(line[1]);
	  current_shape = {name: line[1], indexArray:[], texIndexArray:[],  normalIndexArray: []};
	  obj.shapes.push(current_shape);
  ...
  for(var l=0; l < numberOfShapes; l++){
    ...
    //}
      ...
      shape.positionArray = shape.vertexArray;
